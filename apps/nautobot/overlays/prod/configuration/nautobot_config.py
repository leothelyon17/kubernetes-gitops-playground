...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "00y=972_rtlz!#6a&amp;@r39volxsm+kqcvy68o=wo+7ip=lel-ta")
...
PLUGINS_CONFIG = {
    ...
    "nautobot_secrets_providers": {
        "hashicorp_vault": {
            "url": "http://hashi-vault-prod-0.hashi-vault-prod-internal.svc.cluster.local:8200",
